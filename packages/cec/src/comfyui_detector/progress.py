...
class ProgressReporter:
    ...
    def start_task(self, task_name: str, total_items: Optional[int] = None):
    ...
    def update_task(self, message: Optional[str] = None, current_item: Optional[int] = None):
    ...
    def complete_task(self, summary: Optional[str] = None):
